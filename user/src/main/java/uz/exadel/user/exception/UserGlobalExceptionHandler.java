package uz.exadel.user.exception;
...
@Slf4j(topic = "USER_EXCEPTION_HANDLER")
public class UserGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserAlreadyExistsExceptionException(UserAlreadyExistsException userAlreadyExistsException, WebRequest request){
        log.error("User already exists exception :)");
        return buildErrorResponse(userAlreadyExistsException, HttpStatus.CONFLICT,request);
    }
